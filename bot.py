...
APP_NAME = "🏆 ISEnglishMaster — Твой путь к свободному английскому"
APP_DESCRIPTION = (
    "🌟 *ISEnglishMaster* — лучшее приложение для изучения английского!\n\n"
    "🚀 *Чего ты добьёшься с ISEnglishMaster:*\n\n"
    "✅ *Заговоришь уверенно* — живые разговорные фразы на все случаи жизни\n"
    "✅ *Освоишь грамматику* — от нуля до уровня носителя (A1→C2)\n"
    "✅ *Расширишь словарный запас* — 600+ слов по уровням на флеш-карточках\n"
    "✅ *Будешь видеть прогресс* — умная система целей и статистики\n"
    "✅ *Сдашь любой экзамен* — 600+ упражнений с подробными объяснениями\n\n"
    "━━━━━━━━━━━━━━━\n"
    "💎 *ISEnglishMaster* — это не просто учёба.\n"
    "Это твой личный репетитор, доступный 24/7, бесплатно.\n\n"
    "👇 Открой приложение прямо сейчас и сделай первый шаг к свободному английскому!\n\n"
    "📲 *Поделись с другом* — отправь этого бота тому, кто тоже хочет выучить английский! 🔥"
)
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("🌐 Открыть ISEnglishMaster", url="https://ismail-py59.onrender.com")],
    ]
